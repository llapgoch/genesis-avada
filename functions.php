...
function extra_nav_menu_items( $items, $args ) {
	...
	if(is_user_logged_in()){
		...
		$items .= '<li id="menu-item-logout" class="menu-item control-group menu-item-logout"><a href="'.wp_logout_url('/').'">'.__('Log Out').'</a></li>';
	}else{
	    $items .= '<li id="menu-item-logout" class="menu-item control-group menu-item-login"><a href="'.wp_login_url('/').'">'.__('Log In').'</a></li>';
	}
	return $items;
}
